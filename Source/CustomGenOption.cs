...
namespace KCSG
{
    public class CustomGenOption : DefModExtension
    {
        ...
        public void Generate(IntVec3 loc, Map map)
        {
            ...
            // Get settlement size
            int width = single ? (int)GenOption.structureLayout.sizes.x : (int)GenOption.settlementLayout.settlementSize.x;
            int height = single ? (int)GenOption.structureLayout.sizes.z : (int)GenOption.settlementLayout.settlementSize.y;
